 ...
 */
public class PullScrollViewNew extends ScrollView {
    //底部图片View
    ...
    public PullScrollViewNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PullScrollViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
